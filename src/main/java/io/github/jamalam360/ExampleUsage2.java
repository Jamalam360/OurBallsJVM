...
import static io.github.jamalam360.VKUtil.*;
...
public class ExampleUsage2 {
     ...
     */
    private static final int SPHERE_TESSELATION = 30;
    ...
    private static Pipeline createPipeline(VkDevice device, long renderPass, VkPipelineVertexInputStateCreateInfo vi, long descriptorSetLayout) throws IOException {
        ...
        shaderStages.get(0).set(loadShader(device, "instancedSpheres.vert", VK_SHADER_STAGE_VERTEX_BIT));
        shaderStages.get(1).set(loadShader(device, "instancedSpheres.frag", VK_SHADER_STAGE_FRAGMENT_BIT));
